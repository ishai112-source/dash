            ...
            {entries.map((entry) => (
              <React.Fragment key={entry.id}>
                <TableRow>
                  ...
                  <TableCell>
                    <FormattedNumberInput className="h-7 w-24" value={entry.balance} onChange={(v) => onUpdate(entry.id, "balance", v)} />
                  </TableCell>
                  <TableCell>
                    <FormattedNumberInput className="h-7 w-24" value={entry.monthlyDeposit} onChange={(v) => onUpdate(entry.id, "monthlyDeposit", v)} />
                  </TableCell>
